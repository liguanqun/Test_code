				...
				for (curr_var = 0; curr_var < data_matrix.size(); curr_var++)
					{
						switch (kernel)
							{
							case 2:
								a *= box_pdf(data[curr_var], data_matrix[curr_var][i], bandwidth_map[curr_var]);
								break;
							case 3:
								a *= epanechnikov_pdf(data[curr_var], data_matrix[curr_var][i], bandwidth_map[curr_var]);
								break;
							default:
				...
				for (curr_var = 0; curr_var < data_matrix.size(); curr_var++)
					{
						switch (kernel)
							{
							case 2:
								a *= box_cdf(data[curr_var], data_matrix[curr_var][i], bandwidth_map[curr_var]);
								break;
							case 3:
								a *= epanechnikov_cdf(data[curr_var], data_matrix[curr_var][i], bandwidth_map[curr_var]);
								break;
							default:
								a *= gauss_cdf(data[curr_var], data_matrix[curr_var][i], bandwidth_map[curr_var]);
								break;
							}
					}
				d += a;
